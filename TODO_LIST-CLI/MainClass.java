...
class MainClass {
    ...
    private static void showOption(){
        ...
        System.out.println("          ["+lightgreen_color+"a"+reset_color+"]dd   ["+lightgreen_color+"d"+reset_color+"]elete   ["+lightgreen_color+"e"+reset_color+"]xit");
    ...
    private static void deleteList() {
        if(EncapsulateList.isEmpty()){
            ...
            System.out.print("Processing...");
            try{
                int index = Integer.parseInt(JOptionPane.showInputDialog("Which List"));
                EncapsulateList.removeList(index-1);
            }catch(NumberFormatException nfe){
                /*
                JOptionPane.showMessageDialog(null,"Invalid Input","ERROR",JOptionPane.ERROR_MESSAGE);
                JOptionPane.showMessageDialog(null,nfe.getMessage(),"REASON",JOptionPane.INFORMATION_MESSAGE);
                */
            }
        }
    }
